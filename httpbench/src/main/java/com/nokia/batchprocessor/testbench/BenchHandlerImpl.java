...
public class BenchHandlerImpl extends AbstractHandler implements BenchHandler {
     ...
     * {@inheritDoc}
     * 
     * This implementation uses the expected {@link BenchRequest}/
     * {@link BenchResponse} pairs to serve its requests. If an unexpected
     * request comes in, a {@link BenchServerRuntimeException} is thrown
     */
