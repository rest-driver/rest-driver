...
public class RequestMatcherImpl implements RequestMatcher {
    ...
    /**
     * Checks for a match between an actual {@link HttpServletRequest} and an
     * expected {@link BenchRequest}. This implementation is as strict as it can
     * be with exact matching for Strings, but can also use regular expressions
