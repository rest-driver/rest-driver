...
public final class ClientDriverResponse {
     ...
     * </p>
     * 
     * @param stream The input stream containing the content of the response
     * @param contentType The content type
     */
    ...
    /**
     * Modifies a ClientDriverRequest to specify some time to wait before responding. This enables you to simulate slow
     * services or networks, eg for testing timeout behaviour of your clients.
     * 
     ...
     * @return the object you called the method on, so you can chain these calls.
     * @deprecated You shouldn't need to use this method any more. Use one of the creator methods which specifies a
     *             content-type.
     */
    @Deprecated
