...
import com.googlecode.rat.http.request.DeleteRequest;
import com.googlecode.rat.http.request.GetRequest;
import com.googlecode.rat.http.request.PostRequest;
import com.googlecode.rat.http.request.PutRequest;
import com.googlecode.rat.http.request.Request;
import com.googlecode.rat.http.response.DefaultResponse;
import com.googlecode.rat.http.response.Response;
import com.googlecode.rat.matchers.HasHeader;
import com.googlecode.rat.matchers.HasHeaderWithValue;
import com.googlecode.rat.matchers.HasResponseBody;
import com.googlecode.rat.matchers.HasStatusCode;
import com.googlecode.rat.xml.XmlAcceptanceTestHelper;
...
public final class HttpAcceptanceTestHelper {
    ...
    private static List<Header> headersFromResponse(final HttpResponse response) {
