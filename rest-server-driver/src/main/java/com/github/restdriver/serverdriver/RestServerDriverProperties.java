...
public final class RestServerDriverProperties {
    ...
    static {
        InputStream io = RestServerDriverProperties.class.getClassLoader().getResourceAsStream("rest-server-driver.properties");
    ...
    private RestServerDriverProperties() {
    }
    
    public static String getVersion() {
        return System.getProperty("rest.server.driver.version", "");
    }
